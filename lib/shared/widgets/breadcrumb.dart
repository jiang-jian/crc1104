...
class Breadcrumb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultTextColor = textColor ?? const Color(0xFF666666);
    final defaultActiveColor = activeColor ?? const Color(0xFF333333);
    final defaultSeparatorColor = separatorColor ?? const Color(0xFFCCCCCC);
...
class _BreadcrumbItemWidgetState extends State<_BreadcrumbItemWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    final isClickable = widget.item.path != null && !widget.isLast;
